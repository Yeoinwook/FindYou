...
<link rel="stylesheet" href="<%= request.getContextPath() %>/design/css/normalJoinForm.css">
...
<div class="div_container">
	...
	<h2>
	<label for="title"> 일반회원 회원가입</label>
	</h2>
	
	<form id="normalPass" action="<%=request.getContextPath()%>/join/joinDB.wow" method="post">
	...
	<div class="div_flex">
		...
		<div class="div_right box id">
			...
			<input type="button" class="button btn btn-primary" id="re_button" value="중복확인" onclick="fn_idCheck()">
	...
	<button type="button" id="normal_button" class="btn btn-primary" onclick= "fn_sign()">가입하기</button>
</form>
