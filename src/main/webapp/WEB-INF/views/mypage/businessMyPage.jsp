...
<meta charset="UTF-8">
<title>사업자회원 정보 수정</title>
<link href="https://fonts.googleapis.com/css?family=Jua" rel="stylesheet">
<link rel="stylesheet" href="<%= request.getContextPath() %>/design/css/businessMyPage.css">
...
<div class="div_container">
	...
	<form id="businessPass" action="<%= request.getContextPath() %>/join/modify.wow" method="post">
	...
	<div class="div_flex">
		...
		<div class="div_right box num">
			<input type="text" id="memB2bNumber" value="${member.memB2bNumber}" class="int form-control" maxlength="20" name="memB2bNumber">
	...
	<div class="div_left form-group" style="max-width:150px;">상호명</div>
		<div class="div_right box company">
			<input type="text" id="memCompanyName" value="${member.memCompanyName}" class="int form-control" maxlength="20" name="memCompanyName">
	...
	<div class="div_flex">
		...
		<div class="div_right box email">
			<input type="text"  class="int form-control" value="${member.memEmail}" maxlength="20" name=memEmail>
		</div>
	...
	<div class="div_zip">
		<div class="div_flex div_number">
			...
			<div class="div_right box zip">
				<input type="text" id="memZip" class="int form-control" value="${member.memZip}" maxlength="20" name="memZip" placeholder="우편번호">
		...
		<div class="div_flex div_number">
			<div class="div_left form-group" style="max-width:150px;"></div>
			<div class="div_right box add2" id="div_detail">
	...
	<button type="button" id="normal_button" class="btn btn-primary">완료</button>

	
	<button type="button" id="resign_button" class="btn btn-primary">회원탈퇴</button>
</form>
</div>
</body>
